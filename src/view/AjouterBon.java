...
import controller.BonFournisseurService;
...
public class AjouterBon extends JDialog {
	...
	JComboBox comboBox;
	Client fournisseur;
	PanelBonReception panelBonReception;
	JLabel totalhorstva;
	JLabel ttc;
	 ...
	 * Create the dialog.
	 */
	public AjouterBon(PanelBonReception panelBonReception) {

		super(panelBonReception.panelAchats.frame, "Ajouter Bon");
		this.panelBonReception = panelBonReception;
		...
		this.addWindowListener(new WindowAdapter() {
			...
			public void windowClosing(WindowEvent e) {
				AjouterBon.this.getParent().setEnabled(true);
			}
		...
		btncCancel.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent e) {
				AjouterBon.this.getParent().setVisible(true);
				AjouterBon.this.dispose();
		...
		btnAjouter.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				java.util.Date d = (Date) spinnerdate.getValue();
				if (d.before(date)) {
					JOptionPane.showMessageDialog(AjouterBon.this,
				...
				bfs.add(bf);
				AjouterBon.this.panelBonReception.updatedata();
				((MainWindow) AjouterBon.this.panelBonReception.panelAchats.frame).panelProduits.updatedata();
				JOptionPane.showMessageDialog(AjouterBon.this,
