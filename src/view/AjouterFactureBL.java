...
import controller.FactureFournisseurBLService;
...
public class AjouterFactureBL extends JDialog {
	 ...
	 * Create the dialog.
	 */
	public AjouterFactureBL(PanelFactureBL panelFactureBL) {

		super(panelFactureBL.panelAchats.frame, "Ajouter Facture Fournisseur BL");
		this.panelFactureBL = panelFactureBL;
		...
		this.addWindowListener(new WindowAdapter() {
			...
			public void windowClosing(WindowEvent e) {
				AjouterFactureBL.this.getParent().setEnabled(true);
			}
		...
		btncCancel.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent e) {
				AjouterFactureBL.this.getParent().setVisible(true);
				AjouterFactureBL.this.dispose();
		...
		btnAjouter.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (!(table_panier.getRowCount() > 0)) {
					JOptionPane.showMessageDialog(AjouterFactureBL.this,
				...
				FactureFournisseurBLService fbls = new FactureFournisseurBLService();
				fbls.add(facture);

				AjouterFactureBL.this.panelFactureBL.updatedata();
				JOptionPane.showMessageDialog(AjouterFactureBL.this,
