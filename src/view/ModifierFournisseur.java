...
public class ModifierFournisseur extends JDialog {
	 ...
	 * Create the dialog.
	 */
	public ModifierFournisseur(PanelFournisseur panelClient, Client fournisseur, int index) {
		...
		textFieldmatricule.setText(fournisseur.getMatricule());
		textFieldraison.setText(fournisseur.getRaison());
		if (fournisseur.getType().equals("Physique")) {
			btnNewButton.setSelected(true);
		}
		textFieldfax.setText(fournisseur.getFax());
		textFieldNumFix.setText(fournisseur.getNumFix());
		textFieldnumportable.setText(fournisseur.getNumPortable());
		textFieldEmail.setText(fournisseur.getEmail());
		textFieldSiteweb.setText(fournisseur.getSiteWeb());
		if (!fournisseur.getEtat()) {
		...
		updateaccounttable(fournisseur.getBankAccounts());
		fillcurrentrib(fournisseur);
		...
		btnAjouterClient.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (!Saisie.checkmatricule(textFieldmatricule.getText().trim())) {
					JOptionPane.showMessageDialog(ModifierFournisseur.this,
